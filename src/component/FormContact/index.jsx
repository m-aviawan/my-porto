...
const FormContact = () => {
  ...
  return (
    <div className='z-0'>
        {!hasSubmitted ? (<form onSubmit={HandleSubmit} className='z-[1] flex flex-col gap-1 w-[70%] mx-auto relative top-[50px] md:top-0'>
            <h1 className='text-xl font-bold mb-3 hidden md:contents'>What's your opinion</h1>
